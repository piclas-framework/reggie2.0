            ...
            for compare in compares:
                ...
                if shape1 != shape2:  # e.g.: b1.shape = (48, 1, 1, 32)
                    self.result = tools.red(
                        tools.red(
                            "h5diff failed because datasets for [%s,%s] are not comparable due to different shapes: "
                    ...
                    # The tool h5diff could not be executed
                        ...
                        run.analyze_results.append(
                            tools.red("Maybe h5diff is not found automatically. "
                        ...
                        # fmt: on - causes errors with E501 line too long
