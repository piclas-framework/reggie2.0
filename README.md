...
|                          | analyze\_L2\_file\_error\_name       | L\_2\_ERROR                                           | L_\2                             | string name of the L2 error in the std.out file                                                                            |
|L2 error                  | analyze\_L2                          | 1e-5                                                  | None                             | L2 upper boundary for all nVar. If one L2 error is above the boundary, this test fails                                     |
|                          | analyze\_L2\_error\_name             | L\_2\_ERROR                                           | L_\2                             | string name of the L2 error in the std.out file                                                                            |
...
|                          | analyze\_Convtest\_h\_error\_name    | L\_2\_ERROR                                           | L_\2                             | string name of the L2 error in the std.out file                                                                            |
...
|                          | analyze\_Convtest\_p\_error\_name    | L\_2\_ERROR                                           | L_\2                             | string name of the L2 error in the std.out file                                                                            |
