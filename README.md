...
|                          | h5diff\_sort                         | True                                                  | False                            | Sort h5 arrays before comparing them, which circumvents problems comparing arrays that are written in arbitrary order due to multiple MPI processes writing the dataset (currently only 2-dimensional m x n arrays are implemented) |
|                          | h5diff\_sort\_dim                    | 1                                                     | -1                               | Sorting dimension of an m x n array (1: sort a 2-dimensional array by rows, 2: sort a 2-dimensional array by columns)      |
|                          | h5diff\_sort\_var                    | 1                                                     | -1                               | Sorting variable of the specified dimension. The array will be sorted for this variable in ascending order                 |
